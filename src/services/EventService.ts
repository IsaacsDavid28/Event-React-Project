...
export function GetEventData() :Promise<Events> {
    return axios.get<Events>("https://app.ticketmaster.com/discovery/v2/events.json?size=5&apikey=LG8mjVMbvHfPJKBLUIbBnzPxZ3V2q8ru")
...
export function queryEvent(keyword:string, city:string, stateCode:string) {
    ...
    return axios.get<Events>("https://app.ticketmaster.com/discovery/v2/events.json", {
        params:{
